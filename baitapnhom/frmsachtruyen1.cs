    ...
    public partial class frmsachtruyen1 : Form
    {
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string sql = "insert into sachtruyen(masach,tensach,maloaisach,malinhvuc,matacgia,manhaxuatban,mangonngu,sotrang,giasach,dongiathue,soluong,ghichu) values('"+txtmasach.Text+"','"+txttensach.Text+"','"+txtmaloaisach.Text+"','"+txtmalinhvuc.Text+"','"+txtmatacgia.Text+"','"+txtmanxb.Text+"','"+txtmangonngu.Text+"','"+txtsotrang.Text+"','"+txtgiasach.Text+"','"+txtdongiathue.Text+"','"+txtsoluong.Text+"','"+txtghichu.Text+"') ";
                    SqlCommand cmd = new SqlCommand(sql, DAO.con);
